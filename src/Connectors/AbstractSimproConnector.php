...
use Simpro\PhpSdk\Simpro\Concerns\SupportsContractorInvoicesEndpoints;
use Simpro\PhpSdk\Simpro\Concerns\SupportsContractorJobsEndpoints;
...
use Simpro\PhpSdk\Simpro\Concerns\SupportsJobLogsEndpoints;
...
use Simpro\PhpSdk\Simpro\Concerns\SupportsPrebuildsEndpoints;
...
use Simpro\PhpSdk\Simpro\Concerns\SupportsSitesEndpoints;
use Simpro\PhpSdk\Simpro\Concerns\SupportsTasksEndpoints;
...
abstract class AbstractSimproConnector extends \Saloon\Http\Connector implements Cacheable, HasPagination
{
    ...
    use SupportsContractorInvoicesEndpoints;
    use SupportsContractorJobsEndpoints;
