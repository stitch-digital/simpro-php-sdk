...
final class GetQuoteNoteRequest extends Request
{
    ...
    public function createDtoFromResponse(Response $response): QuoteNote
    {
        return QuoteNote::fromResponse($response);
    }
}
