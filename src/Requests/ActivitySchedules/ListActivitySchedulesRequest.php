...
final class ListActivitySchedulesRequest extends Request implements Paginatable
{
    ...
    /**
     * @return array<ActivityScheduleListItem>
     */
    public function createDtoFromResponse(Response $response): array
    {
        ...
        return array_map(
            fn (array $item) => ActivityScheduleListItem::fromArray($item),
            $data
        );
    }
}
