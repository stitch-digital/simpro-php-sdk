...
namespace Simpro\PhpSdk\Simpro\Requests\Jobs\CostCenters\Tasks;
...
final class GetCostCenterTaskRequest extends Request
{
    ...
    public function createDtoFromResponse(Response $response): CostCenterTask
    {
        return CostCenterTask::fromResponse($response);
    }
}
