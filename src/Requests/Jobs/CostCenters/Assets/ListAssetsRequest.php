...
namespace Simpro\PhpSdk\Simpro\Requests\Jobs\CostCenters\Assets;
...
final class ListAssetsRequest extends Request implements Paginatable
{
    ...
    public function createDtoFromResponse(Response $response): array
    {
        ...
        return array_map(
            fn (array $item) => Asset::fromArray($item),
            $data
        );
    }
}
