...
final class ListIndividualCustomersRequest extends Request implements Paginatable
{
    ...
    /**
     * @return array<CustomerIndividualListItem>
     */
    public function createDtoFromResponse(Response $response): array
    {
        ...
        return array_map(
            fn (array $item) => CustomerIndividualListItem::fromArray($item),
            $data
        );
    }
}
