...
/**
 * Request to list all customers (companies and individuals) with all available columns.
 *
 ...
 */
final class ListCustomersDetailedRequest extends Request implements Paginatable
{
