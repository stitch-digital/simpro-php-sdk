...
/**
 * List customer profiles with full details.
 *
 * Uses the columns parameter to request all available fields,
 * returning full CustomerProfile DTOs instead of list items.
 */
final class ListDetailedCustomerProfilesRequest extends Request implements Paginatable
{
    ...
    public function createDtoFromResponse(Response $response): array
    {
        ...
        return array_map(
            fn (array $item): CustomerProfile => CustomerProfile::fromArray($item),
            $data
        );
    }
}
