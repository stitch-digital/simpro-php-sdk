 ...
 */
final class ListDetailedCustomerTagsRequest extends Request implements Paginatable
{
    protected Method $method = Method::GET;

    /**
     * All columns available for customer tags.
     */
    ...
    public function createDtoFromResponse(Response $response): array
    {
        ...
        return array_map(
            fn (array $item): CustomerTag => CustomerTag::fromArray($item),
            $data
        );
    }
}
