...
final class AssetServiceLevelResource extends BaseResource
{
    ...
    /**
     * Create multiple asset service levels in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/setup/assets/serviceLevels",
            $data,
        );
    ...
    /**
     * Update multiple asset service levels in a single request.
     *
    ...
    /**
     * Delete multiple asset service levels in a single request.
     *
