...
final class ChartOfAccountResource extends BaseResource
{
    ...
    /**
     * Create multiple chart of accounts in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/setup/accounts/chartOfAccounts",
            $data,
        );
    ...
    /**
     * Update multiple chart of accounts in a single request.
     *
    ...
    /**
     * Delete multiple chart of accounts in a single request.
     *
