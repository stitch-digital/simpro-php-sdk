...
final class BusinessGroupResource extends BaseResource
{
    ...
    /**
     * Create multiple business groups in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/setup/accounts/businessGroups",
            $data,
        );
    ...
    /**
     * Update multiple business groups in a single request.
     *
    ...
    /**
     * Delete multiple business groups in a single request.
     *
