...
use Simpro\PhpSdk\Simpro\Requests\Setup\CustomFields\Contacts\ListDetailedContactCustomFieldsRequest;
...
final class ContactCustomFieldResource extends AbstractCustomFieldResource
{
    ...
    {
        return new ListDetailedContactCustomFieldsRequest($companyId);
    }
