...
use Simpro\PhpSdk\Simpro\Requests\Setup\CustomFields\WorkOrders\ListDetailedWorkOrderCustomFieldsRequest;
...
final class WorkOrderCustomFieldResource extends AbstractCustomFieldResource
{
    ...
    {
        return new ListDetailedWorkOrderCustomFieldsRequest($companyId);
    }
