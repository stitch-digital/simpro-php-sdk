...
use Simpro\PhpSdk\Simpro\Requests\Setup\CustomFields\ContractorJobs\ListDetailedContractorJobCustomFieldsRequest;
...
final class ContractorJobCustomFieldResource extends AbstractCustomFieldResource
{
    ...
    {
        return new ListDetailedContractorJobCustomFieldsRequest($companyId);
    }
