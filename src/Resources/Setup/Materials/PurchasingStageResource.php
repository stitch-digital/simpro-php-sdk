...
final class PurchasingStageResource extends BaseResource
{
    ...
    /**
     * Create multiple purchasing stages in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/setup/materials/purchasingStages",
            $data,
        );
    ...
    /**
     * Update multiple purchasing stages in a single request.
     *
    ...
    /**
     * Delete multiple purchasing stages in a single request.
     *
