...
final class UomResource extends BaseResource
{
    ...
    /**
     * Create multiple units of measure in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/setup/materials/uoms",
            $data,
        );
    ...
    /**
     * Update multiple units of measure in a single request.
     *
    ...
    /**
     * Delete multiple units of measure in a single request.
     *
