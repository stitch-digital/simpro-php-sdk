...
final class StockTakeReasonResource extends BaseResource
{
    ...
    /**
     * Create multiple stock take reasons in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/setup/materials/stockTakeReasons",
            $data,
        );
    ...
    /**
     * Update multiple stock take reasons in a single request.
     *
    ...
    /**
     * Delete multiple stock take reasons in a single request.
     *
