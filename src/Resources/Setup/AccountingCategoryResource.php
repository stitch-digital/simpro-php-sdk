...
final class AccountingCategoryResource extends BaseResource
{
    ...
    /**
     * List all accounting categories with full details.
     *
     * Returns AccountingCategory DTOs with all fields (ID, Name, Ref, Archived).
     *
     * @param  array<string, mixed>  $filters
     */
    public function listDetailed(array $filters = []): QueryBuilder
    {
        $request = new ListDetailedAccountingCategoriesRequest($this->companyId);
    ...
    /**
     * Create multiple accounting categories in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/setup/accounts/accCategories",
            $data,
        );
    ...
    /**
     * Update multiple accounting categories in a single request.
     *
    ...
    /**
     * Delete multiple accounting categories in a single request.
     *
