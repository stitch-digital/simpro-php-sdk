...
final class VendorOrderStatusCodeResource extends BaseResource
{
    ...
    /**
     * Create multiple vendor order status codes in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/setup/statusCodes/vendorOrders",
            $data,
        );
    ...
    /**
     * Update multiple vendor order status codes in a single request.
     *
    ...
    /**
     * Delete multiple vendor order status codes in a single request.
     *
