...
final class QuoteArchiveReasonResource extends BaseResource
{
    ...
    /**
     * Create multiple quote archive reasons in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/setup/archiveReasons/quotes",
            $data,
        );
    ...
    /**
     * Update multiple quote archive reasons in a single request.
     *
    ...
    /**
     * Delete multiple quote archive reasons in a single request.
     *
