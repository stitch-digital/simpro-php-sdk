...
final class AssetTypeServiceLevelResource extends BaseResource
{
    ...
    /**
     * Create multiple asset type service levels in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/setup/assetTypes/{$this->assetTypeId}/serviceLevels",
            $data,
        );
    ...
    /**
     * Update multiple asset type service levels in a single request.
     *
    ...
    /**
     * Delete multiple asset type service levels in a single request.
     *
