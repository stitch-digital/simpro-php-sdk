...
final class AssetTypeFailurePointResource extends BaseResource
{
    ...
    /**
     * Create multiple asset type failure points in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/setup/assetTypes/{$this->assetTypeId}/serviceLevels/{$this->serviceLevelId}/failurePoints",
            $data,
        );
    ...
    /**
     * Update multiple asset type failure points in a single request.
     *
    ...
    /**
     * Delete multiple asset type failure points in a single request.
     *
