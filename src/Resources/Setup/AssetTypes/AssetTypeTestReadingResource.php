...
final class AssetTypeTestReadingResource extends BaseResource
{
    ...
    /**
     * Create multiple asset type test readings in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/setup/assetTypes/{$this->assetTypeId}/testReadings",
            $data,
        );
    ...
    /**
     * Update multiple asset type test readings in a single request.
     *
    ...
    /**
     * Delete multiple asset type test readings in a single request.
     *
