...
final class ScheduleRateResource extends BaseResource
{
    ...
    /**
     * Create multiple schedule rates in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/setup/labor/scheduleRates",
            $data,
        );
    ...
    /**
     * Update multiple schedule rates in a single request.
     *
    ...
    /**
     * Delete multiple schedule rates in a single request.
     *
