...
final class FitTimeResource extends BaseResource
{
    ...
    /**
     * Create multiple fit times in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/setup/labor/fitTimes",
            $data,
        );
    ...
    /**
     * Update multiple fit times in a single request.
     *
    ...
    /**
     * Delete multiple fit times in a single request.
     *
