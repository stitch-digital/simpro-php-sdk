...
final class ProjectTagResource extends BaseResource
{
    ...
    /**
     * Create multiple project tags in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/setup/tags/projects",
            $data,
        );
    ...
    /**
     * Update multiple project tags in a single request.
     *
    ...
    /**
     * Delete multiple project tags in a single request.
     *
