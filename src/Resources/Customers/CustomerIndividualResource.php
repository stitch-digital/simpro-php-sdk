...
final class CustomerIndividualResource extends BaseResource
{
    ...
    /**
     * Create multiple individual customers in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/customers/individuals",
            $data,
        );
    ...
    /**
     * Update multiple individual customers in a single request.
     *
    ...
    /**
     * Delete multiple individual customers in a single request.
     *
