...
final class CustomerLaborRateResource extends BaseResource
{
    ...
    /**
     * Create multiple customer labor rates in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/customers/{$this->customerId}/laborRates",
            $data,
        );
    ...
    /**
     * Update multiple customer labor rates in a single request.
     *
    ...
    /**
     * Delete multiple customer labor rates in a single request.
     *
