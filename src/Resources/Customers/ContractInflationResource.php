...
final class ContractInflationResource extends BaseResource
{
    ...
    /**
     * Create multiple contract inflation records in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/customers/{$this->customerId}/contracts/{$this->contractId}/inflation",
            $data,
        );
    ...
    /**
     * Update multiple contract inflation records in a single request.
     *
    ...
    /**
     * Delete multiple contract inflation records in a single request.
     *
