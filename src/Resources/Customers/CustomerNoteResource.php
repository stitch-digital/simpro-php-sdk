...
final class CustomerNoteResource extends BaseResource
{
    ...
    /**
     * Create multiple customer notes in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/customers/{$this->customerId}/notes",
            $data,
        );
    ...
    /**
     * Update multiple customer notes in a single request.
     *
    ...
    /**
     * Delete multiple customer notes in a single request.
     *
