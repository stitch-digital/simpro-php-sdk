...
final class EmployeeAttachmentFolderResource extends BaseResource
{
    ...
    /**
     * Create multiple employee attachment folders in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/employees/{$this->employeeId}/attachments/folders",
            $data,
        );
    ...
    /**
     * Update multiple employee attachment folders in a single request.
     *
    ...
    /**
     * Delete multiple employee attachment folders in a single request.
     *
