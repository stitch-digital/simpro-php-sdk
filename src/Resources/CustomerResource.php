...
final class CustomerResource extends BaseResource
{
    ...
    /**
     * Create multiple company customers in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/customers/companies",
            $data,
        );
    ...
    /**
     * Update multiple company customers in a single request.
     *
    ...
    /**
     * Delete multiple company customers in a single request.
     *
