...
final class JobSectionResource extends BaseResource
{
    ...
    /**
     * Create multiple job sections in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/jobs/{$this->jobId}/sections",
            $data,
        );
    ...
    /**
     * Update multiple job sections in a single request.
     *
    ...
    /**
     * Delete multiple job sections in a single request.
     *
