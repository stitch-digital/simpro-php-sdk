...
final class CatalogResource extends BaseResource
{
    ...
    /**
     * Create multiple catalogs in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/jobs/{$this->jobId}/sections/{$this->sectionId}/costCenters/{$this->costCenterId}/catalogs",
            $data,
        );
    ...
    /**
     * Update multiple catalogs in a single request.
     *
    ...
    /**
     * Delete multiple catalogs in a single request.
     *
