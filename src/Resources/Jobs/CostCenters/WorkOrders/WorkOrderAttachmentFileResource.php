...
final class WorkOrderAttachmentFileResource extends BaseResource
{
    ...
    /**
     * Create multiple work order attachment files in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/jobs/{$this->jobId}/sections/{$this->sectionId}/costCenters/{$this->costCenterId}/workOrders/{$this->workOrderId}/attachments/files",
            $data,
        );
    ...
    /**
     * Update multiple work order attachment files in a single request.
     *
    ...
    /**
     * Delete multiple work order attachment files in a single request.
     *
