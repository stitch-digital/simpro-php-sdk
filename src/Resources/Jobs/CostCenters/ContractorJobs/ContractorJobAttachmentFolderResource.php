...
final class ContractorJobAttachmentFolderResource extends BaseResource
{
    ...
    /**
     * Create multiple contractor job attachment folders in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/jobs/{$this->jobId}/sections/{$this->sectionId}/costCenters/{$this->costCenterId}/contractorJobs/{$this->contractorJobId}/attachments/folders",
            $data,
        );
    ...
    /**
     * Update multiple contractor job attachment folders in a single request.
     *
    ...
    /**
     * Delete multiple contractor job attachment folders in a single request.
     *
