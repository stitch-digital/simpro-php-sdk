...
final class ContractorJobAttachmentFileResource extends BaseResource
{
    ...
    /**
     * Create multiple contractor job attachment files in a single request.
     *
    ...
    public function bulkCreate(array $data): BulkResponse
    {
        $request = new BulkCreateRequest(
            "/api/v1.0/companies/{$this->companyId}/jobs/{$this->jobId}/sections/{$this->sectionId}/costCenters/{$this->costCenterId}/contractorJobs/{$this->contractorJobId}/attachments/files",
            $data,
        );
    ...
    /**
     * Update multiple contractor job attachment files in a single request.
     *
    ...
    /**
     * Delete multiple contractor job attachment files in a single request.
     *
