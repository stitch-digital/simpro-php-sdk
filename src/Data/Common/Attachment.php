...
final readonly class Attachment
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            folder: ! empty($data['Folder']) && is_array($data['Folder']) ? Reference::fromArray($data['Folder']) : null,
            dateAdded: ! empty($data['DateAdded']) ? new DateTimeImmutable($data['DateAdded']) : (! empty($data['DateCreated']) ? new DateTimeImmutable($data['DateCreated']) : null),
            addedBy: ! empty($data['AddedBy']) && is_array($data['AddedBy']) ? StaffReference::fromArray($data['AddedBy']) : null,
