...
final readonly class CustomerBankingDetails
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            paymentMethod: ! empty($data['PaymentMethod']) ? Reference::fromArray($data['PaymentMethod']) : null,
            paymentTermID: $data['PaymentTermID'] ?? 0,
            paymentTerms: ! empty($data['PaymentTerms']) ? CustomerPaymentTerms::fromArray($data['PaymentTerms']) : null,
