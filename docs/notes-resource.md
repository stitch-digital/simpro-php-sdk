...
The Notes resource provides read-only access to notes across your Simpro environment. Currently supports customer notes at the company level, listing all customer notes across all customers.
...
The Notes resource is **read-only** at the company level. To manage notes for a specific customer, use the Customers resource's nested notes endpoints.
